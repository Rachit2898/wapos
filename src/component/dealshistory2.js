...
import { getDealHistory } from "../api/helper";
import { StackActions } from "react-navigation";
export default class Dealshistory2 extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      email: "",
  ...
  componentDidMount = () => {
    getDealHistory()
      ...
      .then((responseJson) => {
        console.log(responseJson, "responsedeal");
        // this.setState({deals:array})
      })
      .catch((error) => {
        console.log(error);
      });
  ...
  renderDeals = ({ item }) => {
    return (
      <View style={styles.col}>
        ...
        <View style={{ width: "33.3%", marginLeft: 23, paddingTop: 40 }}>
