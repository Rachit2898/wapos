...
export default class Userprofile extends React.Component {
  ...
  renderPosts = ({ item }) => {
    return (
      <View
        style={{ marginTop: 5, margin: 15, marginLeft: 0, marginBottom: 0 }}
      >
        <ImageBackground
          source={{
            ...
            >
              ...
              >
                <View style={{ width: "70%", margin: 10 }}>
                  {
                    this.state.LOGINUSERID == this.state.id ? null : (
                      <GradientButton
                        PressAction={() =>
                          this.props.navigation.navigate("Chat", {
                            ...
                            chatlist: 0,
                            NOTIFICATION: this.state.notification_token,
                          })
                        }
                        text={"Message"}
                        color1={"#2145FE"}
                    ...
                    // <GradientButton
                    //     style={{ marginVertical: 8., alignSelf: 'center', marginLeft: 0 }}
                    //     text="Message"
                    ...
                    //     impact
                    //     impactStyle='Light'
                    //     onPressAction={() => this.props.navigation.navigate('Chat', { USERID: this.state.id, USERNAME: this.state.name, USERIMG: this.state.img, chatlist: 0, NOTIFICATION: this.state.notification_token })}
                    // />
                  }
                </View>
              </View>
